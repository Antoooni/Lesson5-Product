			...
			for (int i = 0; i < curSize; i++) {
				...
				for (String h : names) {
					if (h.contains(productsName)) {
						System.out.println("Product: " + productsArray[i].getName() + " id: " + productsArray[i].getId()
								+ " upc: " + productsArray[i].getUpc() + " by " + productsArray[i].getProducer()
								+ " by price: " + productsArray[i].getPrice() + "BYN shelf life: "
								+ productsArray[i].getShelfLife() + " days " + " out of stock: "
